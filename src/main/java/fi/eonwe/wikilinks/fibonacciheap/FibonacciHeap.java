...
{
    /**
     * The array size is actually bounded by log_phi(node_count), but phi^64 ~ 1e13,
     * which should be enough for everyone.
     */
    private static final int MAX_DEGREES = 64;
    private final FibonacciHeapNode[] array = new FibonacciHeapNode[MAX_DEGREES];
