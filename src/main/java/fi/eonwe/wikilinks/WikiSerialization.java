...
public class WikiSerialization {
    ...
    public static List<PackedWikiPage> deserialize(ByteBuffer buffer) {
    ...
    private static void readHeader(ByteBuffer buffer, long[] headerData) {
    ...
    private static List<PackedWikiPage> deserializeInPieces(ByteBuffer input, int[] lastOffset, int[] readCount) {
        return null;
    }
